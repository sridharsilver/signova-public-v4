    ...
    <footer className="relative bg-charcoal text-white overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 pt-20 pb-10">
        <div className="grid lg:grid-cols-5 gap-10 mb-16">
          ...
          <div>
            <h4 className="font-semibold mb-4 text-sm uppercase tracking-wider text-lime">Contact</h4>
            <div className="space-y-3 text-sm text-white/70">
              <div className="flex items-center gap-2"><Mail className="size-4 text-lime" /> info@signovagroup.com</div>
              <div className="flex items-center gap-2"><Phone className="size-4 text-lime" /> +91 98765 43210</div>
              <div className="flex items-center gap-2"><MapPin className="size-4 text-lime" /> Plot 42, Genome Valley, Hyderabad, TS</div>
            </div>
          </div>
        </div>
