...
import { getCropBySlug, deficiencyTemplate, type Deficiency } from "@/data/crops";
...
const ACCENTS: Accent[] = [
  { symbol: "Mg", ring: "ring-emerald-400/40", chip: "bg-emerald-500/15 text-emerald-700 dark:bg-emerald-400/18 dark:text-emerald-200", glow: "from-emerald-500/25 via-emerald-400/10 to-transparent" },
  { symbol: "S", ring: "ring-amber-400/40", chip: "bg-amber-500/15 text-amber-700 dark:bg-amber-400/18 dark:text-amber-200", glow: "from-amber-500/25 via-amber-400/10 to-transparent" },
  { symbol: "Zn", ring: "ring-sky-400/40", chip: "bg-sky-500/15 text-sky-700 dark:bg-sky-400/18 dark:text-sky-200", glow: "from-sky-500/25 via-sky-400/10 to-transparent" },
  { symbol: "B", ring: "ring-rose-400/40", chip: "bg-rose-500/15 text-rose-700 dark:bg-rose-400/18 dark:text-rose-200", glow: "from-rose-500/25 via-rose-400/10 to-transparent" },
];
...
export const Route = createFileRoute("/crops_/$slug/nutrients")({
  loader: ({ params }) => {
    ...
    return { crop, deficiencies: deficiencyTemplate };
  },
  head: ({ loaderData }) => {
        ...
        <div className="max-w-6xl mx-auto px-6 relative">
          ...
          <div className="max-w-3xl mb-14">
            ...
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight">
              Common deficiencies in <span className="text-gradient">{crop.name.toLowerCase()}</span> &amp; how to fix them
            </h2>
